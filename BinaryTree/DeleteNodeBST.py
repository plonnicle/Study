...
#Summary: Given a root node reference of a binary search tree (BST) and a key, delete the node with the key value in the BST. Return the root node reference of the BST.
#Approach: Navigate from the center of the array and check if each value to the left and right are the key value. If so, delete them and return the root. Else, keep going.
#Solution:
